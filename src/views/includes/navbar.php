            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse d-flex justify-content-center " id="navbarNav">
                    <ul class="navbar-nav mb-2 ">
                        <li class="nav-item ">
                            <a class="nav-link" href="/animals"  role="button" aria-expanded="false">
                                Nos animaux
                            </a>
                        </li>
                        <li class="nav-item ">
                            <a class="nav-link" href="/habitat" role="button" aria-expanded="false">
                                Habitat
                            </a>
                        </li>
                        <li class="nav-item ">
                            <a class="nav-link" href="/service"  role="button" aria-expanded="false">
                                Services
                            </a>
                        </li>
                        <li class="nav-item">
                ...
                <button class="btn btn-success ms-4 ">
                    <a data-mdb-dropdown-init href="/login" role="button"  id="navbarNav aria-expanded="false">
