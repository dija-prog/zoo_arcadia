...
$sql = "SELECT animal.animal_nom, habitat.nom AS nom, classe.nom_classe AS nom_classe  FROM animal JOIN habitat ON animal.habitat_id = habitat.habitat_id join classe on animal.id_classe= classe.id_classe ";
